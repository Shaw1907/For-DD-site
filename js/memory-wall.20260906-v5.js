const MEMORY_WALL_VERSION = "memory-wall.20260906-v5";
...
(function initMemoryWall() {
  ...
  function buildMasonry() {
    ...
    // Prefer at most ~2 passes through the unique pool (cuts 4K repeat spam).
    const perColCap = isMobileWidth(width) ? 24 : width >= 2200 ? 16 : 36;
    const maxItems = Math.min(cols * perColCap, IMAGE_COUNT * 2);
    let placed = 0;

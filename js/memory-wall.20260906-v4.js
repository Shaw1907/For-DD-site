const MEMORY_WALL_VERSION = "memory-wall.20260906-v4";
...
(function initMemoryWall() {
  ...
  function measureColumns() {
    ...
    gap = mobile ? 3 : GAP;
    // Phone: denser 6–7 cols (~42–54px) so the wall reads smaller than before.
  ...
  function buildMasonry() {
    ...
    const maxItems = cols * (isMobileWidth(width) ? 24 : 40);
    let placed = 0;

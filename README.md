...
- `js/network.20260614-v17.js` - animated canvas network module, refined 20-second DD morph with mobile-safe letter proportions, readable mobile labels, label-overlap filtering, draggable/tappable names, and expanding purple hover links
...
- `js/mobile-network.20260614-v5.js` - mobile-only network module fork

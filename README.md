...
- `js/network.20260614-v15.js` - animated canvas network module, refined 20-second DD morph with clearer letter structure, denser fine mesh, crisp white nodes, mobile-visible labels, complete 73-name list, draggable names, and expanding purple hover links
...
- `js/mobile-network.20260614-v3.js` - mobile-only network module fork

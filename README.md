...
- `js/network.20260614-v16.js` - animated canvas network module, refined 20-second DD morph with mobile-safe letter proportions, denser fine mesh, crisp white nodes, mobile-visible labels, complete name list, draggable/tappable names, and expanding purple hover links
...
- `js/mobile-network.20260614-v4.js` - mobile-only network module fork

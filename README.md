...
- `js/network.20260614-v22.js` - animated canvas network module, refined 23-second DD morph with protected DD targets, global all-name connection field, stronger local lines, robust phone-detected vertical DD, stable readable mobile labels, and draggable/tappable names
...
- `js/mobile-network.20260614-v10.js` - mobile-only network module fork

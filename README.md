...
- `js/network.20260614-v25.js` - animated canvas network module and attachment-style profile overlay data binding with protected DD targets, full all-to-all name connection field, robust phone-detected vertical DD, profile bio/project/contact/process placeholders, and draggable/tappable names
...
- `js/mobile-network.20260614-v13.js` - mobile-only network module fork

...
- `js/network.20260614-v26.js` - animated canvas network module and attachment-style profile overlay data binding with protected DD targets, full all-to-all desktop connection field, stabilized mobile labels, robust phone-detected vertical DD, profile bio/project/contact/process placeholders, and draggable/tappable names
...
- `js/mobile-network.20260614-v14.js` - mobile-only network module fork
